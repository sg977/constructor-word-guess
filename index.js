...
var wordList = ["siyi", "dean", "edward", "justin", "andrew", "josh", "patrick", "chris", "megan", "angela", "eric", "ben", "alex", "jonathan", "foster"];
...
figlet("Hangman Game", function(err, data) {
    ...
    console.log(gameTextColor("Theme is... people's names from Upenn bootcamp."));
    //Game instructions.
    var howToPlay = 
    "==========================================================================================================" + "\r\n" +
    "How to play" + "\r\n" +
